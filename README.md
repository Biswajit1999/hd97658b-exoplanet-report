...
|---|---:|
| TESS sector | 22 |
| Cadences in comparison | 841 |
| Fitted box depth | 757.5 ± 18.9 ppm |
| Flat χ² / dof / p | 5147.95 / 840 / < 1e-300 |
| Box χ² / dof / p | 3544.26 / 839 / < 1e-300 |
| Improvement Δχ² / Δdof / p | 1603.69 / 1 / < 1e-300 |
...
The fixed archive ephemeris was fitted independently in 1 usable sector(s) (S22). Formal depth errors were inflated by sqrt(max(reduced chi-square, 1)) times the residual time-averaging beta factor (observed range 1.73-1.73). The robust inverse-variance depth is 757.5 +/- 67.2 ppm; a sector-to-sector Q test requires at least two usable sectors. These scaled errors address underestimated scatter and short-timescale correlation, but they are not a full Gaussian-process or physical limb-darkened transit fit.
