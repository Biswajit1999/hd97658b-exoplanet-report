"""Transit-window analysis of a real TESS SPOC light curve for HD 97658 b.
...
DATA_FILE = DATA_DIR / "tess2020049080258-s0022-0000000082308728-0174-s_lc.fits"
PLANET = "HD 97658 b"
PERIOD_DAYS = 9.4897116
EPOCH_BJD = 2458904.9366
DURATION_HOURS = 2.8488
SECTOR = 22
FIGURE_FILE = FIG_DIR / "hd97658b_tess_transit.png"
...
def main() -> dict[str, float]:
    ...
    ax.scatter(hours, (result["flux"] - 1) * 1e6, s=5, alpha=0.12, color="#2f9e44", label="quality-filtered cadences")
    ...
    ax.plot(hours[order], (result["model"][order] - 1) * 1e6,
            color="#2f9e44", linewidth=2.2, label="fitted box model")
    ax.axvspan(-DURATION_HOURS / 2.0, DURATION_HOURS / 2.0, color="#2f9e44", alpha=0.08)
